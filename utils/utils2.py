...
class Earthquake:
    ...
    def intensity_subplot(df_station,t_max,origin_time,comp):    
        ...
        for i,station in enumerate(df_station.index):
            ...
            axes1 = axes[i].twinx()
            axes[i].plot(times,data,'r-',linewidth=0.7)
            ...
            axes[i].set_title(station_name + ' ' + station_channel +'   ' + 'Hypocentral Distance: {} km'.format(hyp_dist),fontdict={'fontsize': 12, 'fontweight':'bold','color':'blue'})
